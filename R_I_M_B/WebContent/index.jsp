			...
			<ul class="nav main-menu">
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						...
						<span class="hidden-xs">Foros</span>
					</a>
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/ForoMentoria.jsp">Foro de Mentoria</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/SolicitudMentor.jsp">Solicitud de Mentor</a></li>
						<li><a class="ajax-link" href="ajax/solicitudMentoria.jsp">Solicitud de Mentoría</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-building-o"></i>
						<span class="hidden-xs">Universidades</span>
					</a>
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/PlanDeEstudio.jsp">Plan de Estudio</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/TIpoPublicacion.jsp">Tipo de Publicacion</a></li>
					</ul>
				</li>
